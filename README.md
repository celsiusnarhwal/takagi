...
| `groups`             | A list of IDs of organizations the user is a member of and has authorized your application to access. Each organization ID is prefixed with `org:`. If the user does not authorize your application to access any organizations, this claim will not be present. | `groups`                                      |
...
[^5]: It's possible to create a key yourself, but there are [several requirements](https://github.com/celsiusnarhwal/takagi/blob/9737ea5feade52809c8168b9714d36ac871480b3/takagi/settings.py#L127).
